        ...
        <div className="container px-5 md:py-24 py-12 mx-auto">
          ...
          >
            ...
            <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">
              Explore our diverse services portfolio designed to meet your
              unique needs, offering a range of solutions that elevate your
          ...
          <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
            ...
            >
              <div className="bg-gray-100 rounded flex p-4 h-full items-center">
                ...
                <span className="title-font font-medium">Graphic Designing</span>
              </div>
            </motion.div>
          </div>
